...
def main():
    ...
    # checking point
    parser.add_argument('--resume', type=str, default='/home/xupeihan/Code/pytorch-deeplab-xception/pretrian_model/deeplab-resnet.pth',
                        help='put the path to resuming file if needed')
    parser.add_argument('--checkname', type=str, default='deeplab-resnet-ft',
